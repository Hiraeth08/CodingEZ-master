...
void default_constants() {
  // P, I, D, and Start I
  chassis.pid_drive_constants_set(40, 0.0, 400);         // Fwd/rev constants, used for odom and non odom motions chassis.pid_drive_constants_set(40, 0.0, 400.0);         
...
void grab_red_reject_blue() {
    ...
    intake.move(-40); // Reverse the intake slowly to push out the blue blocks
...
void grab_blue_reject_red() {
    ...
    intake.move((-127)*0.04); // Reverse the intake slowly to push out the red ring
